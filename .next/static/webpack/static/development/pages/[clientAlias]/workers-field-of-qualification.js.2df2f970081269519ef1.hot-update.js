...
module.exports = __webpack_require__(/*! core-js/library/fn/symbol/replace */ "./node_modules/core-js/library/fn/symbol/replace.js");
...
__webpack_require__(/*! ../../modules/es6.regexp.replace */ "./node_modules/core-js/library/modules/es6.regexp.replace.js");
module.exports = __webpack_require__(/*! ../../modules/_wks-ext */ "./node_modules/core-js/library/modules/_wks-ext.js").f('replace');
...
/* harmony import */ var _src_Utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../src/Utils */ "./src/Utils.ts");
  ...
  return {
    ...
    rows: parents.map(function (row) {
      return {
        ...
        formattedData: ["".concat(row.LabelName), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.NoYear1), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.PerYear1), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.BMYear1), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.NoYear2), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.PerYear2), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.BMYear2), formatChangeNumber(row.Change12, '--')],
        childRows: row.children.map(function (childRow) {
          return {
            ...
            formattedData: ["".concat(childRow.LabelName), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(childRow.NoYear1), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(childRow.PerYear1), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(childRow.BMYear1), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(childRow.NoYear2), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(childRow.PerYear2), Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(childRow.BMYear2), formatChangeNumber(childRow.Change12, '--')]
          };
        })
      };
    }),
    footRows: footerRows.map(function (row) {
      return {
        ...
        cols: [{
          ...
          cssClass: '',
          displayText: Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.NoYear1),
          colSpan: 1
        }, {
          cssClass: '',
          displayText: Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.PerYear1),
          colSpan: 1
        }, {
          cssClass: '',
          displayText: Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.BMYear1),
          colSpan: 1
        }, {
          cssClass: '',
          displayText: Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.NoYear2),
          colSpan: 1
        }, {
          cssClass: '',
          displayText: Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.PerYear2),
          colSpan: 1
        }, {
          cssClass: '',
          displayText: Object(_src_Utils__WEBPACK_IMPORTED_MODULE_5__["formatNumber"])(row.BMYear2),
          colSpan: 1
        }, {
          cssClass: '',
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mapByKey", function() { return mapByKey; });
...
/* harmony import */ var _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/map */ "./node_modules/@babel/runtime-corejs2/core-js/map.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_9__);
...
/* harmony import */ var _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/parse-int */ "./node_modules/@babel/runtime-corejs2/core-js/parse-int.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12__);
...
var getClassNames = function getClassNames(styles, classes) {
  if (lodash__WEBPACK_IMPORTED_MODULE_13___default.a.isEmpty(classes)) {
    return;
  }

  var classArr = lodash__WEBPACK_IMPORTED_MODULE_13___default.a.split(classes, ' ');

  var classNames = '';

  lodash__WEBPACK_IMPORTED_MODULE_13___default.a.forEach(classArr, function (classN) {
    classNames += lodash__WEBPACK_IMPORTED_MODULE_13___default.a.isUndefined(styles[classN]) ? ' ' + classN : ' ' + styles[classN];
  });
...
var detectIE = function detectIE() {
  ...
  if (msie > 0) {
    ...
    return _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12___default()(ua.substring(msie + 5, ua.indexOf('.', msie)), 10);
  }
  ...
  if (trident > 0) {
    ...
    return _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12___default()(ua.substring(rv + 3, ua.indexOf('.', rv)), 10);
  }
  ...
  if (edge > 0) {
    ...
    return _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12___default()(ua.substring(edge + 5, ua.indexOf('.', edge)), 10);
  } // other browser
...
var buildQueryStringWithObjectKeys = function buildQueryStringWithObjectKeys(obj, jointer) {
  return lodash__WEBPACK_IMPORTED_MODULE_13___default.a.map(lodash__WEBPACK_IMPORTED_MODULE_13___default.a.keys(obj), function (key) {
    return key + '=' + obj[key];
  }).join(jointer);
};
...
var deserialiseQueryString = function deserialiseQueryString(query) {
  return lodash__WEBPACK_IMPORTED_MODULE_13___default.a.chain(query).replace('?', '') // width=727&height=647&layers=1,4&zoom=14&lat=-36.641495731141354&lon=146.76125049591067&mapstyle=road
  .split('&') // ["width=727","height=647", ...]
  // @ts-ignore
  .map(lodash__WEBPACK_IMPORTED_MODULE_13___default.a.partial(lodash__WEBPACK_IMPORTED_MODULE_13___default.a.split, lodash__WEBPACK_IMPORTED_MODULE_13___default.a, '=', 2)) // [["width","727"],["height","647"], ...]
...
function naturalSort(a, b) {
  ...
  var xD = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12___default()(mhre, 16) || xN.length !== 1 && Date.parse(x);
  var yD = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_12___default()(yhre, 16) || xD && y.match(dre) && Date.parse(y) || null;

  var normChunk = function normChunk(s, l) {
    return (!s.match(ore) || l === 1) && _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_11___default()(s) || s.replace(snre, ' ').replace(sre, '') || 0;
  };
...
var mergeArraysById = function mergeArraysById(a1, a2, id) {
  return a1.map(function (itm) {
    return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_10__["default"])({}, a2.find(function (item) {
      return item[id] === itm[id] && item;
    }), itm);
  });
};
function mapByKey(list, keyGetter) {
  var map = new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_9___default.a();
  ...
  var mapAsc = new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_9___default.a(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_8__["default"])(map).sort());
  return mapAsc;
}
...
var formatNumber = function formatNumber(number) {
  return numeral__WEBPACK_IMPORTED_MODULE_14___default()(number).format('0,0');
};
var formatPercent = function formatPercent(number) {
  var zero = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '0';
  return number ? numeral__WEBPACK_IMPORTED_MODULE_14___default()(number).format('0,0.0') : zero;
};
var formatChangeNumber = function formatChangeNumber(number) {
  var zero = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '0';
  return number ? numeral__WEBPACK_IMPORTED_MODULE_14___default()(number).format('+0,0') : zero;
};
var formatChangePercent = function formatChangePercent(number) {
  var zero = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '0';
  return number ? numeral__WEBPACK_IMPORTED_MODULE_14___default()(number).format('+0,0.00') : zero;
};
...
//# sourceMappingURL=workers-field-of-qualification.js.2df2f970081269519ef1.hot-update.js.map