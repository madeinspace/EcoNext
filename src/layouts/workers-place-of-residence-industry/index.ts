...
const fetchData = async ({ filters }) => {
  ...
  console.log('DestByOccSumData: ', DestByOccSumData);
  ...
  entities: [
    ...
    },
    {
      ...
      renderString: ({ data, contentData, filters }): string => {
        ...
        // const occupationText = +filters.Indkey === 24000 ? '' : ` as ${data.currentOccupationName}`;
        ...
        return '';
        // `Of the ${formatNumber(total.Number)} local workers ${occupationText} in ${
