  ...
  return {
    ...
    rows: parents.map(row => ({
      ...
      formattedData: [
        ...
        formatShortDecimal(row.LJtoERYear1),
        formatNumber(row.LJNoYear2),
        formatNumber(row.ERYear2),
        formatShortDecimal(row.LJtoERYear2),
      ],
      childRows: row.children.map(childRow => ({
        ...
        formattedData: [
          ...
          formatShortDecimal(childRow.LJtoERYear1),
          formatNumber(childRow.LJNoYear2),
          formatNumber(childRow.ERYear2),
          formatShortDecimal(childRow.LJtoERYear2),
        ],
      })),
    })),
    footRows: footerRows.map(row => {
      return {
        ...
        cols: [
          ...
          { cssClass: '', displayText: formatShortDecimal(row.LJtoERYear1), colSpan: 1 },
          { cssClass: '', displayText: formatNumber(row.LJNoYear2), colSpan: 1 },
          { cssClass: '', displayText: formatNumber(row.ERYear2), colSpan: 1 },
          { cssClass: '', displayText: formatShortDecimal(row.LJtoERYear2), colSpan: 1 },
        ],
      };
    }),
    noOfRowsOnInit: 0,
