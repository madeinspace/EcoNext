...
const entityData = exportID => {
  ...
  switch (exportID) {
    case `1`:
      anchor = 'total-imports';
      entityTitle = 'total imports';
      yAxisTitle = 'total';
      break;
    case `2`:
    ...
    case `3`:
      ...
      entityTitle = 'international imports';
...
const MajorDifferencesHeading = ({ areaName, benchmarkName }) => {
  ...
  return (
    <Highlight>
      The major differences between {entityData(currentExportId).entityTitle} by industries of {areaName} and{' '}
      {benchmarkName} were:
    </Highlight>
  );
};
...
const ImportsByIndustryPage = () => {
  ...
  return (
    <>
      <PageIntro>
        <div>
          ...
          <p>
            ...
            {LinkBuilder(
              `https://economy.id.com.au/${clientAlias}/topic-notes?#domestic-imports-by-industry`,
      ...
      <ItemWrapper>
        <EntityTable data={tableParams} name={'Imports'} />
      </ItemWrapper>
...
export default ImportsByIndustryPage;
