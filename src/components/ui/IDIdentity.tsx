...
`;
export default () => (
  <_IDIdentity href="https://home.id.com.au/demographic-resources/" target="_BLANK">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 50">
      ...
      <path
        ...
        style={{ fill: '#757575' }}
      ></path>
      <path d="M212.49,18.19H214v1.66h-1.5Zm0,3.93H214v9h-1.5Z" style={{ fill: '#757575' }}></path>
      <path
      ...
      <line
        ...
        x2="129.73"
        y2="37.91"
        style={{ fill: 'none', stroke: '#dedede', strokeMiterlimit: 10 }}
      ></line>
      <path
      ...
      <path
        ...
        style={{ fill: '#757575' }}
      ></path>
      <path d="M100.19,17.43v-2.3h2.08v2.3Zm0,15.73V20.58h2.08V33.16Z" style={{ fill: '#757575' }}></path>
      <path
        ...
        style={{ fill: '#757575' }}
      ></path>
      <path d="M115.36,37.91h-2.13l1.38-4.76L110.3,20.58h2.53l3,9.94,3-9.94h2.32Z" style={{ fill: '#757575' }}></path>
      <path
        ...
        style={{ fill: '#757575' }}
      ></path>
      <path d="M7.92,14.53h3.8v3.3H7.92Zm3.8,5.67V33.27H7.92V20.2Z" style={{ fill: '#212121' }}></path>
      <path
        ...
        style={{ fill: '#212121' }}
      ></path>
      <path d="M4.85,33.43a1.92,1.92,0,1,0-1.92-1.92,1.92,1.92,0,0,0,1.92,1.92" style={{ fill: '#ff4612' }}></path>
    </svg>
  </_IDIdentity>
);
