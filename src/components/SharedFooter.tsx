      ...
      <PoweredBy>
        <LogoBox>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 100">
            ...
            <path d="M7.61,78.77a6.1,6.1,0,1,0-6.09-6.09,6.09,6.09,0,0,0,6.09,6.09" style={{ fill: '#ff4612' }} />
            <path
            ...
            <path
              ...
              style={{ fill: '#757575' }}
            />
            <rect x="112.76" y="51.01" width="1.46" height="12.25" style={{ fill: '#757575' }} />
            <path
            ...
            <path
              ...
              style={{ fill: '#757575' }}
            />
            <path d="M128.72,54.72h1.41v8.54h-1.41Zm0-3.71h1.41v1.56h-1.41Z" style={{ fill: '#757575' }} />
            <path
        ...
        >
          <StaticFooterHeading>Powered by .id - the population experts for Hobsons Bay City</StaticFooterHeading>
          <StaticFooterText>
            .id community is an evidence-base for over 250 local government areas in Australia and New Zealand, helping
